...
download_hostname() {
    #udp ==> https://downloads.nordcdn.com/configs/files/ovpn_legacy/servers/nl735.nordvpn.com.udp1194.ovpn
    #tcp ==> https://downloads.nordcdn.com/configs/files/ovpn_legacy/servers/nl735.nordvpn.com.tcp443.ovpn
...
update_hostname() {
    ...
    log "Updating configs for docker-deluge-openvpn"
